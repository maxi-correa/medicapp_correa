...
<div class="container">
    ...
    <table id="<?php echo $idTabla; ?>" class="table table-hover texto-mediano raleway text-center  relaway w-100 p-3 " >
        ...
        <tbody class="text-center" id="<?php echo $idBody; ?>">
           
        </tbody>
        <?php if ($footerTabla){ ?>
          <tfoot id="footerTableCertificado" class="gris">
            <div id="idFooter" class="d-flex justify-content-end">
            </div>
          </tfoot>  
        <?php } ?>
    </table>
