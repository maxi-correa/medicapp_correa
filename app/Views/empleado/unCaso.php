...
<body>
    ...
    <div class="container">
        <div class="d-flex align-items-center justify-content-between encabezado ">
            <button class='rojo' onclick="location.href='<?= base_url('menu-empleado')?>'">Atrás</button>
                    ...
                    <tr>
                        <?php foreach ($datosEmpleado as $unDato): ?>
                            ...
                            <th> <?php
                                    ...
                                    ?></th>
                            <th>
                                <?php $fechaFin = $unDato->fechaFin;
                                if ($fechaFin != null) {
                                    $fecha = new DateTime($fechaFin);
                                    echo $fecha->format("d/m/Y");
                                } else {
                                    echo "Sin fecha de cierre";
                                }
                                ?>
                            </th>
...
<script type="text/javascript">
    ...
    var btnSubirCertificado = "<?= $display ?>";
